...
var DefaultKeyMap = KeyMap{
	...
	NextPane:        key.NewBinding(key.WithKeys("tab", "right", "l"), key.WithHelp("tab/l", "navigate")),
	PreviousPane:    key.NewBinding(key.WithKeys("shift+tab", "left", "h"), key.WithHelp("shift+tab/h", "navigate")),
